...
export class MongooseAnalyzeController {
  ...
  @Get('requests')
  findAllRequests(@Query() filterDto: MonitoringRequestFilterDto): Promise<MonitoringListResponse<RequestLog>> {
  ...
  @Get('mongo-logs')
  findAllMongooseLogs(@Query() filterDto: MonitoringMongoFilterDto): Promise<MonitoringListResponse<MongooseLog>> {
