...
export class SequelizeMonitoringAnalyzeController {
  constructor(private readonly sequelizeMonitoringAnalyzeService: SequelizeMonitoringAnalyzeService) { }

  @Get('requests')
  findAllRequests(@Query() filterDto: MonitoringRequestFilterDto): Promise<MonitoringListResponse<SequelizeRequestLog>> {
  ...
  @Get('db-logs')
  findAllDb(@Query() filterDto: MonitoringSequelizeFilterDto): Promise<MonitoringListResponse<SequelizeDBLog>> {
  ...
  @Get('jobs')
  findAllJobs(@Query() filterDto: MonitoringJobFilterDto): Promise<MonitoringListResponse<SequelizeJobLog>> {
